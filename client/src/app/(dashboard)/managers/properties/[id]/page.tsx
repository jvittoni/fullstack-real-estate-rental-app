...
const PropertyTenants = () => {
    ...
    const getCurrentMonthPaymentStatus = (leaseId: number) => {
        ...
        // If paymentStatus might be undefined, coerce to string explicitly
        // return currentMonthPayment?.paymentStatus?.toString() ?? "Not Paid";
    };
              ...
              px-4 rounded-md flex items-center justify-center hover:bg-neutral-700 hover:text-neutral-50`}
                    ...
                    {leases?.length === 0 ? (
                        <div className="py-10 text-center text-gray-500 text-sm">
                            <span>No tenants found for this property.</span>
                        </div>
                    ) : (
                        <>
                                    ...
                                    <TableBody>
                                        {leases?.map((lease) => (
                                            <TableRow key={lease.id} className="h-24">
                                                ...
                                                <TableCell>
                                                    ${lease.rent.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                                </TableCell>
                                    ...
                                    <div key={lease.id} className="border rounded-lg p-4 shadow-sm">
                                        ...
                                        <div className="text-sm space-y-2">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span>${lease.rent.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                                            </div>
