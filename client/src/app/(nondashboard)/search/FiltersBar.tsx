        ...
        <div className="flex justify-between items-center w-full py-5">
            ...
            <div className="flex justify-between items-center gap-4 p-2">
                ...
                <Button
                    variant="outline"
                    className={cn(
                        "gap-2 rounded-xl border-neutral-400 hover:bg-neutral-700 hover:text-neutral-100",
                        isFiltersFullOpen && "bg-neutral-800 text-neutral-100"
                    )}
              ...
              border hover:bg-neutral-700 hover:text-neutral-50`}
                ...
                >
                    <SelectTrigger className="w-32 rounded-xl border-neutral-400">
