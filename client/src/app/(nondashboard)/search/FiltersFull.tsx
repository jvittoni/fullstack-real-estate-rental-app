            ...
            <div className="flex flex-col space-y-6">
                ...
                <div className="flex gap-4 mt-6 flex-col lg:flex-row">
                    <Button
                        ...
                        className="flex-1 bg-neutral-800 hover:bg-neutral-900 text-white rounded-xl cursor-pointer"
                    >
                        APPLY
                    </Button>
                    <Button
                        onClick={handleReset}
                        variant="outline"
                        className="flex-1 rounded-xl cursor-pointer hover:bg-neutral-100"
                    >
                        Reset Filters
                    </Button>
                </div>
